...
public class Controller {
    ...
    private void musicPlayer(){
        AudioClip clip = new AudioClip(getClass().getResource("/com/laoiseearle/audio/" + notes.getKeyPressed() + ".wav").toString());
        clip.play();
        if(hasStarted){
            newGuess();
        }
    ...
    private void changeNoteColour(){
        ...
        noteColourImage = new Image(getClass().getResourceAsStream("/com/laoiseearle/images/note" + setNoteColour + ".png"));
